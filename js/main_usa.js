...
function loadServices(server) {
    ...
    $.ajax({
        type: 'GET', url: 'api/service/getServiceUsa', data: { token, server }, dataType: 'json',
...
function doBuy() {
    ...
    $.ajax({
        type: 'GET', url: 'api/service/buynumberusa', data: { token, server, service }, dataType: 'json',
        success: function(res) {
    ...
    card.innerHTML = `
        <div class="sms-card-inner">
            <div class="sms-top-row">
                <div class="sms-service-badge"><i class="bi bi-phone-fill"></i> ${item.app || 'USA Number'}</div>
...
function setSMSInterval(elementId, orderId, token, number) {
    ...
    const interval = setInterval(() => {
        $.ajax({
            type: 'GET', url: 'api/service/getMessageUsa', data: { order_id: orderId, token }, dataType: 'json',
...
function checkOrder() {
    ...
    $.ajax({
        type: 'GET', url: 'api/service/ActiveNumberUsa', data: { token }, dataType: 'json',
        success: function(res) {
...
function cancelNumber(orderId, btnId, number) {
    Notiflix.Confirm.show('Confirm Cancel', 'Cancel number +' + number + '? You will be refunded.', 'Yes, Cancel', 'No',
        function() {
            ...
            $.ajax({
                type: 'GET', url: 'api/service/cancelNumberUsa', data: { token, order_id: orderId }, dataType: 'json',
                success: function(res) {
