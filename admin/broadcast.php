...
<div class="page-header">
  <div>
    <nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item active">Broadcast</li></ol></nav>
    <h1 class="h4 mb-0">Broadcast</h1>
  </div>
</div>
      ...
      <div class="card-body p-4">
        ...
        <form method="post">
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message" name="message" rows="4" maxlength="500" placeholder="Write an important update for users..." required><?= htmlspecialchars($message, ENT_QUOTES, 'UTF-8') ?></textarea>
