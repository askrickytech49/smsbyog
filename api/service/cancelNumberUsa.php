...
if (!isset($_GET['order_id']) || $_GET['order_id'] == "") {
    ...
    if ($check_token === false) {
        ...
        if (mysqli_num_rows($sql1) != 1) {
            ...
            // --- No SMS received — fetch USA API credentials and cancel ---
            ...
            // FIX: trim trailing space — was "{$api_url}/api/cancel " with a trailing space
            ...
            try {
                $lock = mysqli_query($conn, "SELECT id, sms_text, service_price FROM active_number WHERE order_id='$order_id' AND active_status='2' AND status='2' AND api_id='1' LIMIT 1 FOR UPDATE");
                ...
                refund_once($conn, (int)$user_id, $order_id, $locked['service_price'], 'cancelNumberUsa');
