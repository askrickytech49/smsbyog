...
if (!$_api_st['usa']) { redirect('buy-number'); }


$page_title = "Buy USA Numbers — " . $site_data['web_name'];
?>
      ...
      <div class="container-fluid py-4">
        <div class="row justify-content-center">
          <div class="col-xl-7 col-lg-8 col-md-10 col-12">
            ...
            <!-- SERVER SWITCHER — dynamic, hides disabled APIs -->
            <div class="server-switcher">
              ...
              <?php if($_as['usa']): ?><span class="server-switch-btn current"><i class="bi bi-flag"></i> USA Only</span><?php endif; ?>
...
<script src="js/main_usa.js"></script>
